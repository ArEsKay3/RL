...
class MegatronPolicyWorkerImpl(
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        # to a subprocess that never accepts them. The socket is adopted
        # immediately before the frontends start instead. The port holder keeps
        # it bound and listening until then, so there is still no window in
        # which the pre-published URL could be stolen.
